...
const Contactus = () => {
  ...
  >
    <div className="flex flex-col justify-between">
      <div>
        <h2 className="text-4xl lg:text-5xl font-bold leading-tight">
          Lets Get in<span className="text-gold"> Touch!</span>
        </h2>
        <div className="text-gray-700 mt-8">
        Use the form to reach out or call us directly – your exclusive ride awaits.
        </div>
        <div className="text-gray-700 mt-8">
          Hate forms? Send us an <a href="mailto:your-email@example.com" className="underline">email</a> instead.
        </div>

        <div className="flex gap-5 mt-8">
          <div className="flex text-gold text-4xl"><LuPhoneCall  /></div>
          <div className="flex flex-col gap-3">
            <div className="flex text-gold text-lg">Call for book an order:</div>
            <a href="tel:+1231231234" className="flex text-2xl">+1 123 123 1234</a>
          </div>
        </div>
      </div>
      <div className="mt-8 text-center">
        ...
        >
          ...
          <path
            ...
            opacity="0.1"
          />
          <circle cx="776.11" cy="438.7" r="9.04" fill="#D7B65D" />
          <path
          ...
          <path
            ...
            opacity="0.1"
          />
          <circle cx="758.03" cy="419.83" r="8.84" fill="#D7B65D" />
          <path
          ...
          <path
            ...
            fill="#2f2e41"
          />
          <ellipse cx="451.95" cy="431.55" rx="2.19" ry="2.2" fill="#D7B65D" />
          <path
          ...
          <path
            ...
            fill="#D7B65D"
          />
          <ellipse cx="450.2" cy="420.35" rx="8.52" ry="8.57" fill="#D7B65D" />
          <path
    ...
    <div className="bg-gray-100 text-gray-900 rounded-sm shadow-sm p-8">
      ...
      <div className="mt-5 flex gap-3 flex-col md:flex-row">
        <div>
          <span className="uppercase text-sm text-gray-600 font-bold">Date</span>
          <input
            className="
              w-full
        ...
        <div>
          <span className="uppercase text-sm text-gray-600 font-bold">Time</span>
          <input
            className="
              w-full
      ...
      <div className="mt-5">
        <span className="uppercase text-sm text-gray-600 font-bold">Pick Up</span>
        <input
          className="
            w-full
      ...
      <div className="mt-5">
        <span className="uppercase text-sm text-gray-600 font-bold">Drop Off</span>
        <input
          className="
            w-full
      ...
      <div className="mt-5">
        <span className="uppercase text-sm text-gray-600 font-bold">Vehicle</span>
        <select
          className="
            w-full
      ...
      <div className="mt-8">
      <button className="main-button mt-7"><span>SEND</span></button>
      </div>
    </div>
  </div>
</div>
