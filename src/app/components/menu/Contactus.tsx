        ...
        >
          <div className="flex flex-col justify-between">
            <div>
              ...
              <div
                ...
                data-aos-delay="50"
              >
                Use the form to reach out or call us directly – your exclusive
                ride awaits.
              </div>
              <div
                className="text-gray-700 mt-8"
              ...
              >
                ...
                <a href="mailto:sblimousine123@gmail.com" className="underline">
                  email
                </a>{' '}
                instead.
              </div>
              ...
              <div
                ...
                data-aos-delay="150"
              >
                <div className="flex text-gold text-4xl">
                  <LuPhoneCall />
                </div>
                <div className="flex flex-col gap-3">
                  ...
                  <a href="tel:+12363356123" className="flex text-2xl">
                    +1 236-335-6123
                  </a>
                </div>
              </div>
          ...
          "
              >
                ...
                <option value="GMC">GMC Yukon</option>
